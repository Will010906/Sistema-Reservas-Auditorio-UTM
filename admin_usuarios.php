        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-header bg-dark text-white rounded-top-4">
                    <h5 class="modal-title fw-bold" id="tituloModalUsuario">Editar Usuario</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <form id="formUsuario" action="modules/editar_usuario.php" method="POST">
                    <div class="modal-body p-4">
                        <input type="hidden" name="id_usuario" id="user_id">

                        <div class="mb-3" id="div_matricula">
                            <label class="form-label small fw-bold text-muted">Matrícula</label>
                            <input type="text" name="matricula" id="user_matricula" class="form-control rounded-3" required>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <select name="carrera_area" id="user_carrera" class="form-select rounded-3" required>
                                    ...
                                    <?php /* Opciones de carreras oficiales de la UTM */ ?>
