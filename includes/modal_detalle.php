            ...
            <div class="modal-body p-4">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="x-small fw-bold text-muted text-uppercase mb-1 d-block">Otros requerimientos</label>
                        <div id="detEquipamiento" class="d-flex flex-wrap gap-1">
                        </div>
                    </div>
                </div>
                <div id="seccionBitacoraAdmin" class="mt-3" style="display: none;">
                    <div class="alert-sira-purple p-3 shadow-sm d-flex align-items-start gap-3">
                        <i class="bi bi-chat-square-text-fill fs-5" style="color: var(--sira-purple-primary);"></i>

                        <div class="flex-grow-1">
                            <label class="text-info-sira fw-800 d-block mb-1 text-uppercase">
                                Reporte de Entrega e Incidentes (Finalización)
                            </label>
                            <p id="detBitacoraTexto" class="small italic mb-0 opacity-75" style="line-height: 1.4;">
                                "---"
                            </p>
                        </div>
                    </div>
