            ...
            <div class="modal-body p-4">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="p-2 bg-light rounded mb-3" id="detDescription" style="font-size: 0.85rem; min-height: 50px;">---</div>
                ...
                <div class="row align-items-center">
                    <div class="col-md-7">
                        <textarea id="motivoRechazo" class="form-control border-0 bg-light" rows="2" placeholder="Opcional: Motivo de rechazo o instrucciones..." style="border-radius: 12px;"></textarea>
                    </div>
