        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 24px; overflow: hidden; background-color: #fcfcfc;">
            ...
            <div class="modal-header text-white p-4 border-0" style="background: linear-gradient(135deg, #3a2741 0%, #5B3D66 100%);">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="modal-title fw-800 mb-0" style="letter-spacing: -0.5px; font-weight: 800;">Nueva Reservación de Espacio</h4>
            ...
            <div class="modal-body p-0 bg-white">
                ...
                <div id="paso_catalogo" class="p-4 p-lg-5 animate__animated animate__fadeIn">
                    <div class="d-flex align-items-center mb-4 px-2 pb-3 border-bottom">
                        ...
                        <h5 class="fw-800 text-uppercase mb-0" style="letter-spacing: 1px; color: #5B3D66; font-weight: 800;">Selecciona el Auditorio o Espacio</h5>
                    </div>
                ...
                <div id="paso_calendario" class="p-4 p-lg-5 animate__animated animate__fadeIn" style="display: none;">
                    <button class="btn btn-sm text-primary fw-bold mb-4 p-0 d-flex align-items-center gap-2" onclick="regresarAlCatalogo()" style="font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px;">
                        <i class="bi bi-arrow-left fs-5"></i> Volver al catálogo de espacios
                    </button>
                    
                    <div class="row g-4">
                        <div class="col-lg-8">
                            <div id="calendar_interactivo" class="shadow-sm border rounded-4 bg-white p-4" style="border-radius: 16px;"></div>
                        </div>
                        <div class="col-lg-4">
                            <div class="card border shadow-sm rounded-4 h-100 p-4 bg-white" style="border-radius: 16px;">
                                <h6 class="fw-800 text-uppercase mb-4 pb-2 border-bottom" style="color: #5B3D66; font-weight: 800; font-size: 0.8rem; letter-spacing: 1px;">Configuración de Horario</h6>

                                <div class="mb-4">
                                    <label class="form-label label-sira-pro">Fecha del Evento Seleccionada</label>
                                ...
                                <h6 class="fw-800 text-uppercase mb-2 mt-4" style="color: #5B3D66; font-size: 0.7rem; font-weight: 800; letter-spacing: 1px;">Bloques de Horas Disponibles:</h6>
                ...
                <div id="paso_formulario" class="p-4 p-lg-5 animate__animated animate__fadeIn" style="display: none;">
                    <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom">
                        <button type="button" class="btn btn-sm text-primary fw-bold p-0 d-flex align-items-center gap-2" onclick="irAlCalendario(auditorioSeleccionado, document.getElementById('display_nombre_final').innerText)" style="font-size: 0.8rem; text-transform: uppercase; letter-spacing: 1px;">
                            <i class="bi bi-arrow-left fs-5"></i> Cambiar Fecha u Horario
                        </button>
                        <div class="text-end">
                            <h5 id="display_nombre_final" class="fw-800 text-dark mb-0" style="font-weight: 800; font-size: 1.3rem; letter-spacing: -0.5px;">Auditorio</h5>
                    ...
                    <form id="formNuevaReservacion">
                        ...
                        <div class="row g-5">
                            <div class="col-lg-7 border-end pe-lg-5">
                                <h6 class="fw-800 text-uppercase mb-4 pb-2 border-bottom" style="color: #5B3D66; font-weight: 800; font-size: 0.8rem; letter-spacing: 1px;">Información General del Evento</h6>
                                
                                <div class="mb-4">
                                    <label class="form-label label-sira-pro">Nombre Completo del Evento</label>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group input-group-sira-pro rounded-3 overflow-hidden border">
                                            ...
                                            <input type="number" name="num_asistentes" id="num_asistentes_input" class="form-control border-0 p-3" style="font-size: 1rem;" placeholder="Cantidad" min="1" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label label-sira-pro">Otros Requerimientos (Opcional)</label>
                                        <input type="text" name="otros_servicios" class="form-control input-sira-pro" placeholder="Ej. Cafetería, presídium, etc.">
                                    </div>
                                </div>

                                <div class="mb-0">
                                    <label class="form-label label-sira-pro">Justificación o Descripción de la Actividad</label>
                                    <textarea name="descripcion" class="form-control input-sira-pro" rows="4" placeholder="Describe brevemente el propósito de tu evento..." required></textarea>
                                </div>
                            </div>

                            <div class="col-lg-5 ps-lg-4">
                                <h6 class="fw-800 text-uppercase mb-4 pb-2 border-bottom" style="color: #5B3D66; font-weight: 800; font-size: 0.8rem; letter-spacing: 1px;">Resumen Visual del Espacio</h6>
                                ...
                                <div class="row g-3">
                                    <div class="col-6 border-end">
                                        <label class="fw-bold text-primary d-block mb-2 text-uppercase" style="font-size: 0.6rem; letter-spacing: 1px;">EL ESPACIO INCLUYE:</label>
                                    ...
                                    <div class="col-6 ps-3 sira-checks-pro-success">
                                        <label class="fw-bold text-success d-block mb-2 text-uppercase" style="font-size: 0.6rem; letter-spacing: 1px;">SOLICITAR EXTRAS:</label>
...
<style>
    /* VARIABLES DE COLOR Wilmer Approved */
    :root {
    ...
    /* 1. INTERACTIVIDAD DEL CALENDARIO (ADIÓS BORDE VERDE) */
    ...
    /* Día seleccionado en Morado UTM */
    .fc-day-selected, 
    ...
    .fc-prev-button.fc-button:hover, .fc-next-button.fc-button:hover {
    ...
    .btn-enviar-sira:hover {
        ...
        box-shadow: 0 8px 20px rgba(91, 61, 102, 0.3) !important;
    }
